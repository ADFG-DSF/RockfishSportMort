...
jagsUI::traceplot(postH, parameters = c(
                                        "mu_beta4_yellow","tau_beta4_yellow",
                                        "beta4_yellow",
                                        "beta5_yellow"))

jagsUI::traceplot(postH, parameters = c("mu_beta4_dsr","tau_beta4_dsr",
...
jagsUI::traceplot(postH, parameters = c("mu_beta4_pelagic_kod",
                                        "mu_beta5_pelagic_kod",
                                        "tau_beta4_pelagic_kod",
                                        "tau_beta5_pelagic_kod"))
jagsUI::traceplot(postH, parameters = c("mu_beta4_yellow_kod",
                                        "mu_beta5_yellow_kod",
                                        "tau_beta4_yellow_kod",
