...
knit: (function(input_file, encoding) {
        rmarkdown::render(input_file, 
                          output_file = paste0("RFsportmort_update_", "LB_cens_",Sys.Date(),".html"))
      })
---
...
res <- "HR_censLBR_thru2023_1400000_7kn_2024-12-13"
...
2. *Complete convergence* has not been achieved and at this juncture the logistic cuves used for pH and p_comp appear to tbe the last hurdle. Spline parameters are resolving nicely in these models. 
3. *Prior choices* in general need to be vetted. Ideally, sensitivity testing would occur but the model is very slow to converge. The beta parameters on the logistic curves have required a lot of work on the priors to reach convergence. 
