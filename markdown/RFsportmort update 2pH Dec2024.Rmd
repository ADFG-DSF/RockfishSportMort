...
knit: (function(input_file, encoding) {
        rmarkdown::render(input_file, 
                          output_file = paste0("RFsportmort_update_", "LB_hyb_3pH_",Sys.Date(),".html"))
      })
---
...
#mod <- "LB_cens_hb2"
#mod<-"LB_fit_hb2"
#res <- "HR_fitLBR_2bias_hierbeta2_3pH_thru2023_750000_7kn_2025-01-09"
res <- "HR_hybLBR_2bias_hierbeta2_3pH_thru2023_8e+05_7kn_2025-01-09"
...
```{r, fig.width = 10, fig.height = 8, fig.cap = "**Figure 13.**- Annual proportion of non-pelagic, non-yelloweye rockfish catch that was harvested. Note that pre-1990 estimates are used to estimate catch in these years when catch estimates are not available."}
