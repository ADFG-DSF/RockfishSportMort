...
knit: (function(input_file, encoding) {
        rmarkdown::render(input_file, 
                          output_file = paste0("RFsportmort_update_", "LB_hyb_hb2_DRAFT_",Sys.Date(),".html"))
      })
---
...
res <- "HR_hybLBR_2bias_hierbeta2_2pH_thru2023_1e+05_7kn_2024-12-20"
...
if (mod %in% c("LB_fit","LB_hyb_2b","LB_hyb_2b_hb2","LB_fit_hb2")){
  as.data.frame(
...
if (mod %in% c("LB_fit","LB_hyb_2b","LB_hyb_2b_hb2","LB_fit_hb2","LB_hyb_hb2","LB_fit_hb2")) { #2 bias
...
if (mod %in% c("LB_fit","LB_hyb_2b","LB_hyb_2b_hb2","LB_fit_hb2","LB_hyb_hb2","LB_fit_hb2")){
