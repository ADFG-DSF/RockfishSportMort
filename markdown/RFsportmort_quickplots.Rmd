...
knit: (function(input_file, encoding) {
        rmarkdown::render(input_file, 
                          output_file = paste0("Gen4_", "pHB4pars_swhsR_alwt_r0full_modslepssqz_",Sys.Date(),".html"))
      })
---
...
res <- "Gen4int_indcomp_swhsR_FULL_pHB4pars_re0full_altwt_slepssquz_thru2024_6e+05_2025-11-09"
