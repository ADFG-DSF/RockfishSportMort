...
pel_m_source %>% filter(user != "all" & area %in% southeast) %>%
  ggplot(aes(x = year, y = M_prop, fill = M_source)) +
  scale_fill_manual(values = pal) +
  scale_color_manual(values = pal) +
  geom_bar(position="fill", stat="identity") +
...
pel_m_x_source %>% filter(user != "all" & area %in% southeast) %>%
  ggplot(aes(x = year, y = Mortalities, fill = Source)) +
  scale_fill_manual(values = pal) +
  scale_color_manual(values = pal) +
  geom_bar(position="stack", stat="identity") +
...
dsr_m_x_source %>% filter(user != "all" & area %in% southeast) %>%
  ggplot(aes(x = year, y = Mortalities, fill = Source)) +
  scale_fill_manual(values = pal) +
  scale_color_manual(values = pal) +
  geom_bar(position="stack", stat="identity") +
...
slope_m_source %>% filter(user != "all" & area %in% southeast) %>%
  ggplot(aes(x = year, y = M_prop, fill = M_source)) +
  scale_fill_manual(values = pal) +
  scale_color_manual(values = pal) +
  geom_bar(position="fill", stat="identity") +
