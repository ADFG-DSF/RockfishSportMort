...
mod<-"LB_fit_3pH"
#mod<-"LB_hyb_3pH"
res <- "rf_harvest_est_kha_rm_wt_thru2023_1500000_7kn_2025-05-25"
...
```{r, fig.width = 11.5, fig.height = 5, fig.cap = paste0("**Figure ",X,".**- DSR rockfish (including yelloweye) harvests 1996--2023. Lines and error polygons represent model estimates and points and error bars represent Howard et al estimates.")}
...
ggsave("../figures/bayes_model/dsr_harvests.png", width = 8, height = 4) 
X <- X+1
...
```{r, fig.width = 11.5, fig.height = 5, fig.cap = paste0("**Figure ",X,".**- DSR rockfish releases (including yelloweye) 1996--2023. Lines and error polygons represent model estimates and points and error bars represent Howard et al estimates.")}
#pal <- wes_palette(name = "Darjeeling1", n=3)
pal <- wes_palette(name = "AsteroidCity1", n=3)
...
ggsave("../figures/bayes_model/dsr_releases.png", width = 8, height = 4) 
X <- X+1
...
```{r, fig.width = 11.5, fig.height = 5, fig.cap = paste0("**Figure ",X,".**- Slope rockfish harvests 1996-2023. Lines and error polygons represent model estimates and points and error bars represent Howard et al estimates.")}
#BottleRocket2 2,3 or 2,4 Rushmore1 2,3,4 Darjeeling 1,2,3,4,5 FantasticFox1 3,4,5
#library(paletteer); scale_colour_paletteer_d("nationalparkcolors::Acadia")
...
ggsave("../figures/bayes_model/slope_harvests.png", width = 8, height = 4) 
X <- X+1
...
```{r, fig.width = 11.5, fig.height = 5, fig.cap = paste0("**Figure ",X,".**- Slope rockfish releases 1996--2023. Lines and error polygons represent model estimates and points and error bars represent Howard et al estimates.")}
#pal <- wes_palette(name = "Darjeeling1", n=3)
pal <- wes_palette(name = "Rushmore1")[c(3,4)] 
...
ggsave("../figures/bayes_model/slope_releases.png", width = 8, height = 4) 
...
unique(brf_m$area)
#rep_wb$add_worksheet("Black_Mort_Lbs")
#rep_wb$add_data("Black_Mort_Lbs", brf_m)
```
...
```{r, fig.width = 11.5, fig.height = 8, fig.cap = paste0("**Figure ",X,".**- Pelagic rockfish estimated total removals in lbs in 1996--2023. Total removals are calculated from the harvests, the estimated release mortality and mean fish weights. Error polygons represent 95% confidence intervals.")}
pal <- wes_palette(name = "IsleofDogs1", n=6)
...
ggsave("../figures/bayes_model/pel_removals.png", width = 8, height = 4) 
X <- X+1
...
```{r, fig.width = 11.5, fig.height = 8, fig.cap = paste0("**Figure ",X,".**- Non-yelloweye, demersal shelf rockfish estimated total removals in lbs in 1996-2023. Total removals are calculated from the harvests, the estimated release mortality and mean fish weights. Error polygons represent 95% confidence intervals.")}
...
ggsave("../figures/bayes_model/dsr_removals.png", width = 8, height = 4) 
X <- X+1
...
```{r, fig.width = 11.5, fig.height = 8, fig.cap = paste0("**Figure ",X,".**- Slope rockfish estimated total removals in lbs in 1996-2023. Total removals are calculated from the harvests, the estimated release mortality and mean fish weights. Error polygons represent 95% confidence intervals.")}
pal <- wes_palette(name = "Rushmore1")[c(3,4,5)] 
...
ggsave("../figures/bayes_model/slope_removals.png", width = 8, height = 4) 
X <- X+1
...
ggsave("../figures/bayes_model/p_harv_pelagics.png") 
X <- X+1
...
ggsave("../figures/bayes_model/p_harv_ye.png") 
X <- X+1
...
ggsave("../figures/bayes_model/p_harv_nonyenonpel.png") 
X <- X+1
...
ggsave("../figures/bayes_model/p_pelagic.png") 
X <- X+1
...
pal <- c(wes_palette(name = "IsleofDogs1", n=2),"red","blue","darkcyan") 
...
rbind(p_black_obs %>% select(year,p_black,user,area),
  ...
  scale_shape_manual(values = c(18, 18,10,2,2)) +
  scale_size_manual(values = c(2,2,3,2.25,2.25))

ggsave("../figures/bayes_model/p_black.png") 
X <- X+1
...
ggsave("../figures/bayes_model/p_ye.png") 
X<-X+1
...
```{r, fig.width = 11.5, fig.height = 5, fig.cap = paste0("**Figure ",X,".**- Annual estimates of the percent of the sport harvest of non-pelagic rockfish that were DSR rockfish for 6 Southeast commerical fishing manamgent areas, 1996-2023.")}
pal <- wes_palette(name = "AsteroidCity1", n=3) 
...
ggsave("../figures/bayes_model/p_dsr.png", width = 8, height = 4) 
X <- X+1
...
```{r, fig.width = 11.5, fig.height = 5, fig.cap = paste0("**Figure ",X,".**- Annual estimates of the percent of the sport harvest of non-pelagic rockfish that were slope rockfish for 6 southeast commerical fishing manamgent areas, 1996-2023. Note that P(yelloweye) is the the proportion relative to non-pelagics for Central and Kodiak areas but is relative to DSR for Southeast areas.")}
pal <- wes_palette(name = "Rushmore1")[c(3,4)] 
...
ggsave("../figures/bayes_model/p_slope_harv.png", width = 8, height = 4) 
X <- X+1
...
```{r, fig.width = 11.5, fig.height = 5, fig.cap = paste0("**Figure ",X,".**- Annual estimates of the percent of the sport non-pelagic, non-yelloweye releases that were slope rockfish for 6 southeast commerical fishing manamgent areas, 1996-2023. ")}
pal <- wes_palette(name = "Rushmore1")[c(3,4)] 
...
ggsave("../figures/bayes_model/p_slope_rel.png", width = 8, height = 4) 
X <- X+1
...
brf_wt_mod %>% #filter(user != "all") %>%
  ...
  geom_point(data  = brf_wt_obs) +
  #geom_line(data = brf_wt_mod, aes(color = user)) +
  #geom_line(data = pHpel_trend, aes(color = user)) +
  #geom_hline(data = p_pelagic_trend, aes(yintercept = p_pelagic), linetype = 2) +
  #coord_cartesian(ylim = c(0, 1)) +
  facet_wrap(. ~ area) +
  scale_shape_manual(values = c(18, 10)) + theme_bw(base_size = 16)+
  theme (axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  labs(y = "Wt (lbs)", x = "Year")

ggsave("../figures/bayes_model/brf_wts.png") 
X <- X+1
...
ye_wt_mod %>% #filter(user != "all") %>%
  ...
  #geom_point(aes(shape = source)) + 
  geom_line() + geom_point(alpha = 0.5) +
  geom_point(data  = ye_wt_obs) +
  facet_wrap(. ~ area) +
  scale_shape_manual(values = c(18, 10)) + theme_bw(base_size = 16)+
  theme (axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  labs(y = "Wt (lbs)", x = "Year")

ggsave("../figures/bayes_model/ye_wts.png") 
X <- X+1
...
``` 
<br>
```{r, fig.width = 10, fig.height = 8, fig.cap = paste0("**Figure ",X,".**- Mean weights of non-black, pelagic rockfish used to estimate biomass from harvest and release mortality estimates in numbers of fish.")}
pal <- wes_palette(name = "Moonrise2", n=3)
...
pel_wt_mod %>% filter(area %in% southeast) %>%
  ...
  #geom_point(aes(shape = source)) + 
  geom_line() + geom_point(alpha = 0.5) +
  geom_point(data  = pel_wt_obs) +
  facet_wrap(. ~ area) +
  scale_shape_manual(values = c(18, 10)) + theme_bw(base_size = 16)+
  theme (axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  labs(y = "Wt (lbs)", x = "Year")

ggsave("../figures/bayes_model/pel_wts.png") 
X <- X+1
...
``` 
<br>
```{r, fig.width = 10, fig.height = 8, fig.cap = paste0("**Figure ",X,".**- Mean weights of non-yelloweye, demersal shelf rockfish used to estimate biomass from harvest and release mortality estimates in numbers of fish.")}
pal <- wes_palette(name = "Moonrise2", n=3)
...
dsr_wt_mod %>% filter(area %in% southeast) %>%
  ...
  #geom_point(aes(shape = source)) + 
  geom_line() + geom_point(alpha = 0.5) +
  geom_point(data  = dsr_wt_obs) +
  facet_wrap(. ~ area) +
  scale_shape_manual(values = c(18, 10)) + theme_bw(base_size = 16)+
  theme (axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  labs(y = "Wt (lbs)", x = "Year")

ggsave("../figures/bayes_model/dsr_wts.png") 
X <- X+1
...
``` 
<br>
```{r, fig.width = 10, fig.height = 8, fig.cap = paste0("**Figure ",X,".**- Mean weights of slope rockfish used to estimate biomass from harvest and release mortality estimates in numbers of fish.")}
pal <- wes_palette(name = "Moonrise2", n=3)
...
slope_wt_mod %>% filter(area %in% southeast) %>%
  ...
  #geom_point(aes(shape = source)) + 
  geom_line() + geom_point(alpha = 0.5) +
  geom_point(data  = slope_wt_obs) +
  facet_wrap(. ~ area) +
  scale_shape_manual(values = c(18, 10)) + theme_bw(base_size = 16)+
  theme (axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  labs(y = "Wt (lbs)", x = "Year")

ggsave("../figures/bayes_model/slope_wts.png") 
X <- X+1
...
rep_wb$add_data("Non-black Pelagics",PEL_wb)
...
rep_wb$add_data("Non-ye DSR",DSR_wb)
...
rep_wb$add_data("Slope",SLOPE_wb)
...
pal <- wes_palette(name = "Moonrise2", n=2)
...
brf_m_source %>% filter(user != "all") %>%
  ...
  theme_bw(base_size = 14)+
  theme (axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  labs(y = "Proportion of total mortality", x = "Year")

ggsave("../figures/bayes_model/brf_mort_source.png", width = 10, height = 8) 
X <- X+1
...
ggsave("../figures/bayes_model/ye_mort_source.png", width = 10, height = 8) 
X <- X+1
