...
```{r, fig.width = 10, fig.height = 6, fig.cap = paste0("**Figure ",Fig_N,".**- Residuals from SWHS harvests showing the difference between model estimates with the bias correction removed and observed values in the SWHS. The CV of the SWHS data is indicated by the grey scale.")}
...
```{r, fig.width = 10, fig.height = 6, fig.cap = paste0("**Figure ",Fig_N,".**- Residual of SWHS releases showing the difference between model estimates with the bias correction removed and observed values in the SWHS. The CV of the SWHS data is indicated by the grey scale.")}
pal <- wes_palette(name = "Zissou1Continuous", type = "continuous")
...
```{r, fig.width = 10, fig.height = 6, fig.cap = paste0("**Figure ",Fig_N,".**- Residuals from logbook harvest and releases showing the residual relative to the logbook data.")}
as.data.frame(
...
rbind(bc_mod2, bc_obs) %>%
  ...
  theme (axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
         legend.position = "bottom",
         plot.margin = margin(t = 20, r = 5, b = 5, l = 5)) +
  labs(y = "Bias correction for SWHS estimates", x = "Year") +
  scale_colour_grey(start = 0, end = .5) -> Hbias
...
rbind(bc_mod2, bc_obs) %>%
  ...
  theme (axis.text.x = element_text(angle = 45, vjust = 1, hjust=1),
         ...
         plot.margin = margin(t = 20, r = 5, b = 5, l = 5)) +
  labs(y = "", x = "Year") +
  scale_colour_grey(start = 0, end = .5)-> Cbias
...
```{r, fig.width = 10, fig.height = 8, fig.cap = paste0("**Figure ",Fig_N,".**- Annual proportion of pelagic rockfish catch that was harvested. Note that pre-1990 estimates are used to estimate catch in these years when catch estimates are not available.")}
...
```{r, fig.width = 10, fig.height = 8, fig.cap = paste0("**Figure ",Fig_N,".**- Annual proportion of yelloweye rockfish catch that was harvested. Note that pre-1990 estimates are used to estimate catch in these years when catch estimates are not available.")}
...
```{r, fig.width = 10, fig.height = 8, fig.cap = paste0("**Figure ",Fig_N,".**- Annual proportion of non-pelagic, non-yelloweye rockfish catch that was harvested. Note that pre-1990 estimates are used to estimate catch in these years when catch estimates are not available. Note, that this is not estimated for Southeast areas because non=pelagics are divided between DSR (including yelloweye) and Slope species.")}
...
```{r, fig.width = 11.5, fig.height = 8, fig.cap = paste0("**Figure ",Fig_N,".**- Annual estimates of the percent of the sport harvest that was pelagic rockfish for 16 commerical fishing manamgent areas, 1996-2023.")}
pal <- wes_palette(name = "Moonrise2", n=3)
...
rbind(pr_slope_obs %>% filter(area %in% southeast)) %>%
  ...
  facet_wrap(. ~ area) + theme_bw(base_size = 14)+
  theme (axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) +
  labs(y = "Prop. of non-pelagics and non-yelloweye releases that were slope", x = "Year")
...
```{r, fig.width = 11.5, fig.height = 8, fig.cap = paste0("**Figure ",Fig_N,".**- Annual estimates of the percent of harvest by charter anglers for 16 commerical fishing manamgent areas, 1996-2023.")}
pG_mod <- 
  postH$mean$pG %>%
  t() %>%
  as.data.frame() %>%
...
```{r, fig.width = 10, fig.height = 8, fig.cap = paste0("**Figure ",Fig_N,".**- Total rockfish harvests 1996-2023. Lines and error polygons represent model estimates and points and error bars represent Howard et al estimates.")}
...
```{r, fig.width = 12, fig.height = 8, fig.cap = paste0("**Figure ",Fig_N,".**- Black rockfish harvests 1996--2023. Lines and error polygons represent model estimates and points and error bars represent Howard et al estimates.")}
...
```{r, fig.width = 11.5, fig.height = 8, fig.cap = paste0("**Figure ",Fig_N,".**- Yellow rockfish harvests 1996--2023. Lines and error polygons represent model estimates and points and error bars represent Howard et al estimates.")}
...
```{r, fig.width = 10, fig.height = 8, fig.cap = paste0("**Figure ",Fig_N,".**- Total rockfish releases 1996--2023. Lines and error polygons represent model estimates and points and error bars represent Howard et al estimates.")}
