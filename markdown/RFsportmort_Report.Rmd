...
Sampling in Southeast Alaska is not proportional to the distribution of the catch and as such uses a 4-stage weighted average procedure to estimate mean weights (Richards et al. 2025). The 4-stage approach is detailed in Richards et al. (2025) but as of this writing historical weight estimates are being reevaluated and are unavailable. As such, Southeast estimations in this document are only presented as numbers and biomass conversions are omitted for the time being. Nevertheless, the methods and modelling of biomass conversions used for southcentral and Kodiak will be available for the Southeast region at such a time as the weight data becomes available and regional staff wish to use the methods presented here.  
