...
mod <- "LB_hyb"
res <- "model_HCR_hybLBR_xspline_xYE_thru2023_1e+05_2024-11-26"
...
Estimates of guided harvests and releases from the SWHS do not align with the census from charter logbooks. Logbook harvest reports are generally considered reliable and are used to assess the bias in SWHS reports. However, there is even greater disparity between release estimates in the two sources and it is debatable whether logbook releases should be treated as a census. The Howard et al. (2020) methods do treat the logbook release data as "true" and thus are considerably less than would be estimated from the SWHS data. Several models (explained below) were used to estimate releases and determine the best approach going forward. Model development has revealed a tension between the total and pelagic logbook releases and the yelloweye logbook releases.
...
t1 <- param_conv %>% slice(1:(tabl*0.5))
t2 <- param_conv %>% slice(((tabl*0.5)+1):tabl)
